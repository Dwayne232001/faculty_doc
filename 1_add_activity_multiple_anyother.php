...
$noofdays = $days->format('%d');
     ...
     if(isset($_POST['applicable']))
	  ...
	  //checking if there was an error or not
       ...
       if($flag!=0 && $s != 0)
       {
        $sql="INSERT INTO any_other_activity(Fac_ID,activity_name,Date_from,Date_to,purpose_of_activity,organized_by,permission_path,certificate_path,report_path,noofdays) VALUES ('$author',$activityname,$startDate,$endDate,$purposeofactivity,$organizedby,'".$paperpath."','".$certipath."','".$reportpath."',$noofdays)";
			 ...
			 <div class="box box-primary">
                <div class="box-header with-border">
				 <div class="icon">
					...
					<h3 class="box-title"><b>Any Other Activities Form</b></h3>
					<br>
				</div>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="form-group col-md-6">
                    ...
                    <input required type="text" class="form-control input-lg" id="faculty-name" name="facultyName" value="<?php echo $faculty_name; ?>" readonly>
                     ...
                     <div class="form-group col-md-6">
					  ...
					  <input required type="text" class="form-control input-lg"  name="activityname[]" value = '<?php if(isset($_POST['activityname'])) echo $activityname; ?>'>
                     </div>
                     
                     <div class="form-group col-md-6">
                         <label for="organized-by">Organized By</label><span class="colour"><b> *</b></span>
                         <input required type="text" class="form-control input-lg"  name="organizedby[]" value = '<?php if(isset($_POST['organizedby'])) echo $organizedby; ?>'>
                     </div><br><br>
                     ...
                     <div class="form-group col-md-6">
                         ...
                         placeholder="03:10:10" value = '<?php if(isset($_POST['startdate'])) echo $startDate; ?>'>
                     </div><br><br>
                    ...
                    <div class="form-group col-md-6">
                         ...
                         placeholder="03:10:10" value = '<?php if(isset($_POST['enddate'])) echo $endDate; ?>'>
                     </div><br><br>
					 
					 <div class="form-group col-md-6">
                         <label for="purpose-of-activity">Purpose of Activity</label><span class="colour"><b> *</b></span>
                         <input required type="text" class="form-control input-lg"  name="purposeofactivity[]" value = '<?php if(isset($_POST['purposeofactivity'])) echo $purposeofactivity; ?>'>
                     </div>
