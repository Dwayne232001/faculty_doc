        ...
        <div class="col-xs-12">
             ...
             <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h3 class="box-title"><b>STTP/Worlshop/FDP/QIP/Seminar Activity Chart</b></h3>
					<br>	
					</div> 
                </div><!-- /.box-header -->
			<div style="text-align:right">
                ...
                <!-- form start -->
            <form role="form" action = "chart_sttp_faculty.php" method="post">
               <div class="box-body">
                    <div class="form-group col-md-2">
						<label for="type">Select Type:</label>
						<select name='type_sttp' id='type' style="width:150px;">
