...
$query = "SELECT * FROM organised WHERE A_ID=$cardId";
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><strong>Upload Brochure</strong></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="" method="POST" enctype="multipart/form-data" class="row">
					...
					<div class='second-reveal'>
					 <div class="form-group col-md-6">
                         ...
                         <label for="card-image">Brochure * </label>
...
if($_SESSION['type'] == 'hod' || $_SESSION['type'] == 'cod' || $_SESSION['type'] == 'com')
{ ?>
        <a href="2_dashboard_organised_hod.php" type="button" class="btn btn-primary">Cancel</a>
<?php
}
else
{
?>
      <a href="2_dashboard_organised.php" type="button" class="btn btn-primary">Cancel</a>
<?php
}
?>			 
                         <!-- <div style="display: inline;"> 
						 
                             <button name="insert-image" type="submit" class="btn btn-primary">Add</button>
                         </div> -->
                    </div> 
                 </form>
