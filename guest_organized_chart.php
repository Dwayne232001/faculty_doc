...
<!-- Main content -->
      ...
      <!--  <a href="menu.php?menu=1 " style="text-align:right"> <u>Back to Paper Publication/Presentation Menu</u></a>&nbsp&nbsp -->
        ...
        <!-- form start -->
                <form role="form" action = "guest_organized_chart_hod.php" method="post">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    <input type="submit" class="btn btn-primary" name="submit" value = "Count organized Guest lectures"></input>
                    <a href="view_organised_hod_lec.php" type="button" class="btn btn-primary">Back to View Mode </a>
