        ...
        <section class="content">
          <div class="row">
			...
			<!--		<a href="menu.php?menu=7 "> <u>Back to Extra-curricular Menu</u></a> -->
                ...
                <!-- form start -->
                <form role="form" action = "count_all_excurricular.php" method="post">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_hod_excurricular.php" type="button" class="btn btn-primary">Back to View Mode </a>
				 ...
				 if (isset($_POST['count_total']))
				{
					...
					if (($to_date==null && $from_date==null && $sname != null))
					{
						...
						$_SESSION['display'] = $display ; 
								...
								{			
									echo "<br>";
									echo "<strong>Number of Extra-curricular Activities are".$count."</strong><br>";
									echo "<br>";						
				...
				start:
				 ...
				 ?>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" id="print" onclick="window.print();">Print</button>
								...
								<a href="export_to_excel_analysis_all_excurricular.php" type="button" class="btn btn-primary"><span class="glyphicon ">Export to Excel</span></a> 
