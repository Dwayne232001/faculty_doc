...
if(isset($_POST['update'])){
					...
					$sql_approval = "update online_course_attended set FDC_approved_disapproved= $approval_status WHERE OC_A_ID = $OC_A_ID";
						...
						$result_aproval = mysqli_query($conn,$sql_approval);
							...
							if ($conn->query($sql) === TRUE) {
								...
								{
									header("location:5_fdc_dashboard_online_hod.php?alert=update");
								}		
								else
									header("location:5_fdc_dashboard_online.php?alert=update");
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<br>
					<b><a href="menu.php?menu=5 " style="font-size:15px;">Online/Offline Course attended</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="5_fdc_dashboard_onlineattend_hod.php" style="font-size:15px;">&nbsp;FDC Details</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Edit FDC</a></b>						
				</div>                </div><!-- /.box-header -->
                <!-- form start -->
			<?php
			...
			<div class="form-group col-md-6">
                ...
                <form role="form" action = "" method = "POST">
                  ...
                  <div class="form-group">
					...
					<input type="radio" name="approval_status" 
							<?php if ($fdcapproval=="Approved") echo "checked";?>
					
					value ="Approved" > Approve<br>
					
					<input type="radio" name="approval_status" 
							<?php if ($fdcapproval=="Disapproved" || $fdcapproval=="Not Approved") echo "checked";?>
					
					value ="Disapproved" id="approval_status"> Disapprove<br>
				...
				<?php	if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
					{ ?>
                         <a href="5_fdc_dashboard_online_hod.php" type="button" class="btn btn-primary">Cancel</a>

				<?php	}
				else
				{?>
					  <a href="5_fdc_dashboard_online_attended.php" type="button" class="btn btn-primary"">Cancel</a>
