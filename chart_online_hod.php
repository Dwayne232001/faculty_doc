...
<!-- Main content -->
      ...
      <!--  <a href="menu.php?menu=1 " style="text-align:right"> <u>Back to Paper Publication/Presentation Menu</u></a>&nbsp&nbsp -->
        ...
        <!-- form start -->
                <form role="form" action = "chartonline_hod.php" method="post">
                  <div class="box-body">
                    <div class="form-group">
                        ...
                        <select required name='type_online' id='type' class="form-control" style="width: 220px;">
                  ...
                  <div class="box-footer">
                    <input type="submit" class="btn btn-primary" name="submit" value = "Count Courses"></input>
