...
if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
  ...
  $query2 = "SELECT COUNT(*) from researchdetails where Fac_ID=$fid";
}else{
  $query2 = "SELECT COUNT(*) from researchdetails INNER JOIN facultydetails ON researchdetails.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
}
  ...
  <div class="content-wrapper">
      ...
      <div class="col-md-8">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class='alert alert-warning'>You have no research details</div>
                  <!--<div class="chart">
...
<?php
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    $query3 = "SELECT MIN(fromDate) from researchdetails WHERE Fac_ID=$fid ";
  }else{
    $query3 = "SELECT MIN(fromDate) from researchdetails INNER JOIN facultydetails ON researchdetails.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ";
  }
...
while($startYear != $endYear) {
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
	  $query = "SELECT COUNT(*) FROM researchdetails WHERE Fac_ID=$fid AND toDate >= '$date1' AND fromDate <= '$date2' ";
  }else{
    $query = "SELECT COUNT(*) FROM researchdetails INNER JOIN facultydetails ON researchdetails.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' AND toDate >= '$date1' AND fromDate <= '$date2' ";
  }
  ...
  <br><br><br>
        ...
        <section class="content">
		   ...
		   <div class="col-xs-12">
            ...
            <a class="btn btn-primary pull-right" style="height:40px" href="researchChartHOD.php" >Select Another Faculty</a>
