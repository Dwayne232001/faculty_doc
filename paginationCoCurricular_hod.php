...
$_SESSION['currentTab'] = "co";
 ...
 $query = "SELECT * from co_curricular inner join facultydetails on co_curricular.Fac_ID = facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ORDER BY co_curricular_ID DESC LIMIT $start_from,$record_per_page ";  
...
<?php
 ...
 $page_query = "SELECT * from co_curricular inner join facultydetails on co_curricular.Fac_ID = facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ORDER BY co_curricular_ID DESC";  
 ...
 <br>
   <?php if ($_SESSION['rows'] > 0) {
        if($_SESSION['type'] == 'hod'){?>
         <div>
        <a href="1_add_activity_multiple_hod_cocurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Co-Curricular Activity</span></a> 
        <?php }?>
              ...
              <a href="export_to_excel_hod_cocurricular.php" type="button" name="export" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a> 

  <?php }else {
  
if($_SESSION['type'] == 'hod'){?>
              <div class="text-left"><a href="1_add_activity_multiple_hod_cocurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Co-Curricular Activity</span></a>
