...
if(isset($_POST['update'])){
	...
	$sql="UPDATE ex_curricular set activity_name= $activityname, 
									Date_from=$startdate, 
									Date_to=$endDate, 
...
?>				
			   ...
			   <div class="form-group col-md-6">
					...
					<?php
						if($_SESSION['type'] == 'hod')
						{
						   echo '<a href="2_dashboard_hod_excurricular.php" type="button" class="btn btn-warning btn-lg">Cancel</a>';
						}
						else
						{
							echo '<a href="2_dashboard_excurricular.php" type="button" class="btn btn-warning btn-lg">Cancel</a>';
						}
                    ?>						
