...
$nameError = "";
$emailError = "";
$Act_title = $startDate = $act_name = $fdc = $endDate = $Act_type =  $location = $organized_by = $status_activities = $awards = $certificate1_path = $permissionpath = $reportpath = "";
$flag = 0;
$success = 0;
$no_of_hours = $no_of_days = $no_of_weeks = $month = $year = 0;
$fid = $_SESSION['Fac_ID'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['add'])) {
        ...
        $status_activities_array = $_POST['Status_Of_Activity'];
        ...
        for ($i = 0; $i < 1; $i++) {
            ...
            //     $flag = 1;
            // }
            // if (empty($_POST['Status_Of_Activity[]'])) {
            ...
            if ($s != 0) {
                $sql = "INSERT INTO attended(Fac_ID,Act_title,Act_type,Organized_by,Date_from,Date_to, month, year, noofdays,noofweeks, Status_Of_Activity,Category,Permission_path,Report_path,Certificate_Path) VALUES ('$author','$Act_title','$Act_type','$organized_by','$startDate','$endDate',$month,$year,$no_of_days,$no_of_weeks,'$status_activities','$category','" . $permissionpath . "','" . $reportpath . "','" . $certificate1_path . "')";
                echo $sql;
                    ...
                    ?>
                        ...
                        <form role="form" method="POST" class="row" action="" style="margin:10px;align:center" enctype="multipart/form-data">
                            <div class="form-group col-md-6">
                                ...
                                <input required type="text" class="form-control input-lg" id="faculty-name" name="facultyName" value="<?php echo strtoupper($_SESSION['Dept']); ?>" readonly>
                            </div>
                            <div class="form-group col-md-6">
					  ...
					  <input  type="text" class="form-control input-lg"  name="Act_title[]" id="paper-title" required value = '<?php if (isset($_POST['Act_title'])) echo $Act_title; ?>'>
						...
						<select id="paper-type" required name="Act_type[]" class="form-control input-lg" value = '<?php if (isset($_POST['Act_type'])) echo $Act_type; ?>'>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <span class="colour" style="color : red"><b> *</b></span>
                                <input required type="date" class="form-control input-lg" id="start-date" name="Date_from[]" placeholder="1999-12-31" value='<?php if (isset($_POST['Date_from'])) echo $startDate; ?>'>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="end-date">End Date</label>
                                <span class="colour" style="color : red"><b> *</b></span>
                                <input required type="date" class="form-control input-lg" id="end-date" name="Date_to[]" placeholder="1999-12-31" value='<?php if (isset($_POST['Date_to'])) echo $endDate; ?>'>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <span class="colour" style="color : red"><b> *</b></span>
                                <!--   <input required type="text" class="form-control input-lg" id="paper-title" name="Act_title[]">-->
                                <input type="text" class="form-control input-lg" name="Organized_by[]" id="Organized_by" required value='<?php if (isset($_POST['Organized_by'])) echo $organized_by; ?>'>
                            </div>
