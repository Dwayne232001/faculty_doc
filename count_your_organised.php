            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><strong style="margin-left: 10px">STTP/Workshop/FDP Activities Organised Analysis</strong></h3>
                </div><!-- /.box-header -->
				...
				<!-- form start -->
                <form role="form" action = "count_your_organised.php" method="post">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    <input type="submit" class="btn btn-primary" name="count_organised" value = "Count Activities"></input>
                    <a href="2_dashboard_organised.php" type="button" class="btn btn-primary">Back to View Mode </a>
				   ...
				   <?php 
				   $count=0;
				   if (isset($_POST['count_organised']))
					{
						...
						echo "<br>";
						echo "<strong>Number of ".$activities." organised are: ".$count."</strong><br>";
						echo "<br>";
						$sql1 = "SELECT * from organised inner join facultydetails on organised.Fac_ID = facultydetails.Fac_ID  and organised.Date_from >= '$from_date' and organised.Date_to <= '$to_date' and organised.Act_type = '$activities'";
						$res1 = mysqli_query($conn,$sql1);
						$_SESSION['sql'] = $sql1;
			   ...
			   if($count > 0){
			  ?>		  
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" id="print" onclick="window.print();">Print
