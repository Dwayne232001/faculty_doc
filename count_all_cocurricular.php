...
<!-- Main content -->
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h3 class="box-title"><b>Co-curricular Activities Analysis</b></h3>
					<br>
					</div>               
			   </div><!-- /.box-header -->
		...
		<!--			<a href="menu.php?menu=6 "> <u>Back to Co-curricular Menu</u></a> -->
                ...
                <!-- form start -->
                <form role="form" action = "count_all_cocurricular.php" method="post">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_hod_cocurricular.php" type="button" class="btn btn-primary">Back to View Mode </a>
					...
					if (($to_date==null && $from_date==null && $sname != null))
					{
						...
						$from_date=$prevyear.'/06/01';
										...
										if (($a==0) && ($dateset==0))
										{
												...
												$sql1 = "SELECT * from co_curricular inner join facultydetails on co_curricular.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and co_curricular.Date_from >= '$from_date' and co_curricular.Date_from <= '$to_date' ";
								...
								{					
									echo "<br>";
									echo "<strong>Number of Co-curricular Activities are".$count."</strong><br>";
									echo "<br>";				
				...
				start:
				 ...
				 ?>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" id="print" onclick="window.print();">Print</button>
								...
								<a href="export_to_excel_analysis_all_cocurricular.php" type="button" class="btn btn-primary"><span class="glyphicon ">Export to Excel</span></a> 
