...
if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
  ...
  $query2 = "SELECT COUNT(*) from paper_review INNER JOIN facultydetails ON paper_review.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
}
...
<?php
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    $query2 = "SELECT MIN(Date_from) from paper_review INNER JOIN facultydetails ON paper_review.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ";
  }
...
while($startYear != $endYear) {
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    $query = "SELECT COUNT(*) FROM paper_review INNER JOIN facultydetails ON paper_review.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'  AND Date_from >= '$date1' AND Date_from <= '$date2' ";
  }
...
$national=$international=$peer=$nonpeer=$journal=$conference=0;
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    $query3 = "SELECT * from paper_review INNER JOIN facultydetails ON paper_review.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ";
  }
  ...
  <br><br><br>
      ...
      <div class="box box-primary">
          ...
          <div class="icon">
            ...
            <a class="btn btn-primary pull-right" style="height:40px" href="technicalreview_hod.php" >Select Another Faculty</a>
