...
<!-- Main content -->
      ...
      <!--  <a href="menu.php?menu=1 " style="text-align:right"> <u>Back to Paper Publication/Presentation Menu</u></a>&nbsp&nbsp -->
        ...
        <!-- form start -->
                <form role="form" action = "chartexcurricular_hod.php" method="post">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    <input type="submit" class="btn btn-primary" name="submit" value = "Count Ex-curricular Activites"></input>
