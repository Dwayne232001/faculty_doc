			...
			?>							
				<div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                    <div>
                        &nbsp;<label for="course"> Upload Permission Record : Applicable ?<br></label>
                    ...
                    <div>
                        &nbsp;<label for="course"> Certificate copy : Applicable ?<br></label>
                        <span class="colour"><b> *</b></span>
                    ...
                    <div>
                        &nbsp;<label for="course"> Report copy : Applicable ?<br></label>
                        <span class="colour"><b> *</b></span>
