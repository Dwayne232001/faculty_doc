...
$nameError="";
$emailError="";
$activity_name = $startDate = $endDate = $purpose_of_activity  = $organized_by = $certificate1_path=$permissionpath=$reportpath= "";
$flag= 1;
$success = 0;
$s = 1;
$p_id = 0;
...
for($i=0; $i<1;$i++)
{
    ...
    if(isset($_POST['applicable1']))
    {
	  ...
	  //checking if there was an error or not
       ...
       if($flag!=0 && $s != 0)
		{
        $sql="INSERT INTO ex_curricular(Fac_ID,activity_name,Date_from,Date_to,purpose_of_activity,organized_by,certificate_path,report_path,permission_path,noofdays) VALUES ('$author',$activityname,$startDate,$endDate,$purposeofactivity,$organizedby,'".$certificate1_path."','".$reportpath."','".$permissionpath."',$noofdays)";
			...
			<div class="box box-primary">
                <div class="box-header with-border">
				  <div class="icon">
					...
					<h3 class="box-title"><b>Extra-Curricular Activities Form</b></h3>
					<br>
				</div>
                </div><!-- /.box-header -->
                <!-- form start -->
