    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="1_add_paper_multiple_hod.php"><i class="fa fa-circle-o"></i>Add Paper</a></li>
            ...
            <!-- <li class="treeview">
              ...
              <ul class="active treeview-menu">
                <li><a href="1_add_paper_multiple_review_hod.php"><i class="fa fa-circle-o"></i> Add Paper</a></li>
                ...
                <li><a href="technicalreview_hod.php"><i class="fa fa-circle-o"></i>Charts</a></li>
			      ...
			      <li class="treeview">
              <a href="#">
                <i class="fa fa-search"></i> <span>Research Proposal/Projects<br>/Consultancy Projects</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li class=""><a href="researchFormHOD.php"><i class="fa fa-circle-o"></i> Add Research Details</a></li>
                <li><a href="researchViewHOD.php"><i class="fa fa-circle-o"></i> View/Edit Research</a></li>
              ...
              <a href="#">
                ...
                <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="facultyinteraction_hod.php"><i class="fa fa-circle-o"></i>Add Faculty Interaction Details</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="1_add_paper_multiple_attend_hod.php"><i class="fa fa-circle-o"></i>Add Activity attended</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="1_add_paper_multiple_organised_hod.php"><i class="fa fa-circle-o"></i>Add Activity organised</a></li>
                <li><a href="2_dashboard_organised_hod.php"><i class="fa fa-circle-o"></i>View/Edit Activity</a></li>
            ...
            <!-- <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="1"><a href="organised_guest_hod.php"><i class="fa fa-circle-o"></i>Guest Lecture Organised</a></li>
                <li class="2"><a href="view_organised_hod_lec.php"><i class="fa fa-circle-o"></i>View/Edit Orgainsed</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="1_add_course_attended_hod.php"><i class="fa fa-circle-o"></i>Add Attended Course</a></li>
                <!-- <li class=""><a href="1_add_course_organised_hod.php"><i class="fa fa-circle-o"></i>Add Organised Course</a></li> -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="1_add_books_published_hod.php"><i class="fa fa-circle-o"></i>Add Books/Chapter Published</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="1_add_patents_hod.php"><i class="fa fa-circle-o"></i>Patents/IPR/Copyrights</a></li>
            ...
            <li class="treeview">
              <a href="#">
                ...
                <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li class="1" ><a href='industrialvisit_HOD.php'><i class="fa fa-circle-o"></i>Add Activity</a></li>
            ...
            <li class="treeview">
              <a href="#">
                ...
                <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="1_add_activity_multiple_hod_cocurricular.php"><i class="fa fa-circle-o"></i>Add Activity</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="1_add_activity_multiple_hod_excurricular.php"><i class="fa fa-circle-o"></i>Add Activity</a></li>
            ...
            <li class="treeview">
                ...
                <i class="fa fa-angle-left pull-right"></i></a>
					    <ul class="treeview-menu">
                <li><a href="1_add_activity_multiple_hod_anyother.php"><i class="fa fa-circle-o"></i>Add Activity</a></li>
                <li><a href="2_dashboard_hod_anyother.php"><i class="fa fa-circle-o"></i>View/Edit Activity</a></li>
		...
		?>
              ...
              <a href="#">
                <i class="fa fa-files-o"></i> <span>Faculty Publication</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li class=""><a href="1_add_paper_multiple_hod.php"><i class="fa fa-circle-o"></i> Add Paper</a></li>
                <li><a href="2_dashboard_hod.php"><i class="fa fa-circle-o"></i> View/Edit Activity</a></li>
                <li><a href="count_all.php"><i class="fa fa-circle-o"></i> Analysis</a></li>
