...
if(isset($_POST['update'])){
					...
					$sql = "update fdc_attended set min_no = $min_no,serial_no = $serial_no,period = $period,od_approv = '$od_approv',od_avail = '$od_avail', fee_sac = $fee_sac,fee_avail =$fee_avail ,ApprovalStatus=$approval_status WHERE FDC_ID = $id";
		
			$sql_approval = "update attended set ApprovalStatus= $approval_status WHERE A_ID = $A_ID";
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
				...
				<div class="icon">
					...
					<h2 class="box-title"><b>FDC details for STTP/FDP/Workshop attended</b></h2>
					<br>
					<b><a href="menu.php?menu=3 " style="font-size:15px;">STTP/FDP/Workshop attended</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;FDC Details</a></b>	
				</div>                </div><!-- /.box-header -->
                <!-- form start -->
			<?php
			...
			<div class="form-group col-md-6">
                ...
                <form role="form" action = "" method = "POST">
                  ...
                  <div class="form-group">
					...
					<input type="radio" name="approval_status" 
					<?php if ($approvalstatus=="Disapproved") 
						echo "checked";?>
