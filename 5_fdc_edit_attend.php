...
if(isset($_POST['id'])){
    $id = $_POST['id'];
	$_SESSION['id'] = $id;
    $query = "SELECT * from fdc_attended where FDC_ID = $id";
	...
	$fdcapproval = $row['ApprovalStatus'];
	$fac_id = $row['Fac_ID'];
	$P_ID = $row['P_ID'];
	$_SESSION['P_ID'] = $P_ID;
...
if(isset($_POST['update']))
{
					...
					$sql = "update fdc_attended set min_no = $min_no,serial_no = $serial_no,period = $period,od_approv = '$od_approv',od_avail = '$od_avail', fee_sac = $fee_sac,fee_avail =$fee_avail, ApprovalStatus= $fdcapproval WHERE FDC_ID = $id";

					$A_ID = $_SESSION['A_ID'];
					$sql_approval = "update attended set ApprovalStatus= $fdcapproval WHERE A_ID = $A_ID";
						...
						$result_aproval = mysqli_query($conn,$sql_approval);
							...
							if ($conn->query($sql) === TRUE) {
								...
								if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
								{
									...
									header("location:5_fdc_dashboard_attend.php?alert=update");
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
				...
				<div class="icon">
					...
					<br>
					<b><a href="menu.php?menu=3 " style="font-size:15px;">STTP/Workshop/FDP</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="5_fdc_dashboard_attend.php" style="font-size:15px;">&nbsp;FDC Details</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Edit FDC</a></b>						
				</div>
                </div><!-- /.box-header -->
			...
			<div class="form-group col-md-6">
                ...
                <form role="form" action = "" method = "POST">
				  ...
				  <div class="form-group">
                         <label for="Act_title">Activity </label>
                         <textarea class="form-control input-lg" id="Act_title" name="Act_title" rows="2" <?php echo $Act_title; ?> readonly><?php echo $Act_title; ?>
						</textarea>
					 </div>
                  <div class="form-group">
				...
				<?php	if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_attend.php" type="button" class="demo btn btn-warning pull-right btn-lg">Cancel</a>
