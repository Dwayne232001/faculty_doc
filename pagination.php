 <?php
  ...
  $query = "SELECT * FROM faculty where Fac_ID='" . $_SESSION['Fac_ID'] . "' ORDER BY P_ID ASC LIMIT $start_from,$record_per_page ";
     ...
     <div class="box box-primary">
       <div class="box-header with-border">
         <div class="icon">
           ...
           <h2 class="box-title"><b>Faculty Publication Details</b></h2>
       ...
       <div id="table-scroll" class="table-scroll">
         <div class="table-wrap">
           ...
           <tr>  
                ...
                <th class= 'next-to-fixed-side' >Authors</th>
                <th>Co-Authors</th>
 ...
 ";
           ...
           <tr>  
                ...
                <td class= 'next-to-fixed-side'>" . $row['author'] . "</td>
     ...
     <?php
      ...
      $page_query = "SELECT * FROM faculty where Fac_ID='" . $_SESSION['Fac_ID'] . "' ORDER BY P_ID ASC";
