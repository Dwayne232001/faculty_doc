        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h3 class="box-title"><b>Any Other Activity Analysis</b></h3>
					<br>
					</div>
			...
			<!--		<a href="menu.php?menu=8 "> <u>Back to Any Other Activity Menu</u></a> -->
                ...
                <!-- form start -->
                <form role="form" action = "count_all_anyother.php" method="post">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_hod_anyother.php" type="button" class="btn btn-primary">Back to View Mode </a>
				...
				if ($sname==null && $to_date!=null && $from_date!=null)
					{
						...
						$_SESSION['display'] = $display ; 
										...
										if (($a==0) && ($dateset==0))
										{
												...
												$sql1 = "SELECT * from any_other_activity inner join facultydetails on any_other_activity.Fac_ID = facultydetails.Fac_ID and any_other_activity.Date_from >= '$from_date' and any_other_activity.Date_from <= '$to_date' ";
				...
				start:
				 ...
				 ?>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" id="print" onclick="window.print();">Print</button>
								...
								<a href="export_to_excel_analysis_all_anyother.php" type="button" class="btn btn-primary"><span class="glyphicon ">Export to Excel</span></a> 
