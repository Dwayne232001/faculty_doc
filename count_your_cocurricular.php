        ...
        <section class="content">
          <div class="row">
			...
			<!--		<a href="menu.php?menu=6 "> <u>Back to Co-curricular Menu</u></a> -->
                ...
                <!-- form start -->
                <form role="form" action = "count_your_cocurricular.php" method="post">
                  <div class="box-body">
				...
				<label for="InputDateTo">Date To :</label>
				 ...
				 <a href="2_dashboard_cocurricular.php" type="button" class="btn btn-primary" >Back to View Mode </a>
					...
					// $my_var = isset($_POST['myPostData']) ? $_POST['myPostData'] : "";
						   ...
						   $q1="select * from co_curricular where Date_from>='$from_date' AND Date_from<='$to_date' and Fac_ID='$Fac_ID'";
						   $_SESSION['sql']=$q1;
						   $result=$conn->query($q1);
						   $num= $result->num_rows;
						   $_SESSION['count'] = $num;
						   echo "<br><p>Total number of Activities : $num</p>";
						   if($num != 0)
						   {
				   ...
				   if(isset($_SESSION['count']))
				   {
					   ...
					   ?>
						<button class="btn btn-primary" id="print" onclick="window.print();">Print</button>
				 		<a href="export_to_excel_analysis_cocurricular.php" type="button" class="btn btn-primary" id="k2" class="hide1" target="_blank">Export to Excel</a>
