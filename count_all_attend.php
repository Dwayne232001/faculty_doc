              ...
              <div class="box box-primary">
                ...
                <form role="form" action = "" method="post">
				  ...
				  <div class="form-group col-md-6">
					...
					<br>	<input type="date" name="min_date" class="form-control " style="width:220px;">
					</div>
					
					 <div class="form-group col-md-6">
                        <label for="type">Select Activity:</label><span class="colour"><b> *</b></span><br>
						<select required name="activities" class="form-control " style="width:220px;" id="search1">
					...
					<br>	<input type="date" name="max_date" class="form-control " style="width:220px;">
                    </div>
                   <!-- <div class="form-group col-md-6">
					</div> -->
					<!-- <div class="form-group col-md-6">
					...
					<div class="form-group col-md-6">
						...
						<br><select required name='type' id='type' class='form-control' style="width:220px;">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_attend_hod.php" type="button" class="btn btn-primary">Back to View Mode </a>
                  </div>	   
				 <?php
				 $show = 1;
					...
					if (($to_date==null && $from_date==null && $sname != null))
					{
						...
						$act_name = $_POST['activities'];
										...
										if (($a==0) && ($dateset==0))
										{
											...
											{
												if($act_name == "ALL"){
													$sql1 = "SELECT * from attended inner join facultydetails on attended.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and attended.Date_from >= '$from_date' and attended.Date_from <= '$to_date'";
												}else{
													$sql1 = "SELECT * from attended inner join facultydetails on attended.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and attended.Act_type = '$act_name' and attended.Date_from >= '$from_date' and attended.Date_from <= '$to_date'";
												}
											}
											else if($_POST['type'] == 'Organised'){
												if($act_name == "ALL"){
													$sql1 = "SELECT * from organised inner join facultydetails on organised.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and organised.Date_from >= '$from_date' and organised.Date_from <= '$to_date'";
												}else{
													$sql1 = "SELECT * from organised inner join facultydetails on organised.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and organised.Act_type = '$act_name' and organised.Date_from >= '$from_date' and organised.Date_from <= '$to_date'";
												}
											}	
								...
								{						
									echo "<br>";
									echo "<strong>Number of ".$act_name." ".$_POST['type']." are: ".$count."</strong><br>";
									echo "<br>";			
							...
							$act_name = $_POST['activities'];
										...
										if (($a==0) && ($dateset==0))
										{
											if($_POST['type'] == 'Attended')
											{
												if($act_name == "ALL"){
													...
													$sql1 = "SELECT * from attended inner join facultydetails on attended.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and attended.Date_from >= '$from_date' and attended.Date_from <= '$to_date' and attended.Act_type = '$act_name'";
												}
											}
											else if($_POST['type'] == 'Organised'){
												if($act_name == "ALL"){
								...
								{							
									...
									echo "<div class='scroll'><table  class='table table-stripped table-bordered ' id = 'example1'>
										<thead><tr> 
										<td><strong>Faculty Name</font></strong></td>
										<td><strong>Faculty ID</font></strong></td>
										<td><strong>Activity Title</font></strong></td>
										<td><strong>Activity Type</font></strong></td>
										<td><strong>Organized by</font></strong></td>
										<td><strong>From Date</strong></td>
				...
				start:
				 ...
				 ?>
						...
						<?php
						  if($_POST['type'] == 'Attended')
						  { ?> 
							<a href="export_to_excel_sttp_attend_all_analysis.php" type="button" class="btn btn-primary"><span class="glyphicon ">Export to Excel</span></a> 
						 ...
						 {?>
							...
							<a href="export_to_excel_sttp_organised_analysis_all.php" type="button" class="btn btn-primary"><span class="glyphicon ">Export to Excel</span></a> 
