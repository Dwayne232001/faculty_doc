            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h3 class="box-title"><b>Provide no. of form responses for Online/Offline Course Organised Activities</b></h3>
					<br>
					<b><a href="menu.php?menu=5" style="font-size:15px;">Online/Offline Course</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="actcount_course_organised.php" style="font-size:15px;">&nbsp;No. of Online/Offline Courses</a></b>	
					</div>
                </div><!-- /.box-header -->
