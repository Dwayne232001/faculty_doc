...
if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
  ...
  $query2 = "SELECT COUNT(*) from invitedlec INNER JOIN facultydetails ON invitedlec.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ";
}
...
<?php
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    $query2 = "SELECT MIN(durationf) from invitedlec INNER JOIN facultydetails ON invitedlec.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
  }
...
while($startYear != $endYear) {
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    $query = "SELECT COUNT(*) FROM invitedlec INNER JOIN facultydetails ON invitedlec.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' AND durationt >= '$date1' AND durationf <= '$date2' ";
  }
...
if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
  ...
  $query3="SELECT res_type FROM invitedlec INNER JOIN facultydetails ON invitedlec.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
}
...
<div class="content-wrapper">
        ...
        <div class="col-xs-12">
            ...
            <a class="btn btn-primary pull-right" style="height:40px" href="faculty_chart.php" >Select Another Faculty</a>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Research Types</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
