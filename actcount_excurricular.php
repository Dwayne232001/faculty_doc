            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h3 class="box-title"><b>Provide no. of form responses for Extra-curricular activities</b></h3>
					<br>
					<b><a href="menu.php?menu=7" style="font-size:15px;">Extra-curricular activity</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="actcount_excurricular.php" style="font-size:15px;">&nbsp;No. of Extra-curricular activities</a></b>	
					</div>
                </div><!-- /.box-header -->
                ...
                <form role="form" action="" method="POST">
				  ...
				  $username = $_SESSION['username'];
					...
					{
						header("location:1_add_activity_multiple_hod_excurricular.php?alert=success");

					}
					else
						header("location:1_add_activity_multiple_excurricular.php?alert=success");
					}
					}
