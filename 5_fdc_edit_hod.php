            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
				...
				<div class="icon">
					...
					<br>
					<b><a href="menu.php?menu=1 " style="font-size:15px;">Paper Publication</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="5_fdc_dashboard_hod.php" style="font-size:15px;">&nbsp;FDC Details</a><span style="font-size:17px;">&nbsp;&rarr;</span><a href="#" style="font-size:15px;">&nbsp;Edit FDC</a></b>						
				</div>
                </div><!-- /.box-header -->
			...
			<div class="form-group col-md-6">
				...
				<?php	if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_hod.php" type="button" class="demo btn btn-warning pull-right btn-lg">Cancel</a>
