...
$_SESSION['currentTab']="technical_review";
			...
			//	echo urldecode($d);
				...
				else if($display == 2)
				{
					if($count4 > 0)
					{
						$sql = "SELECT * from paper_review inner join paper_reviewdetails on paper_review.Fac_ID = paper_reviewdetails.Fac_ID and paper_reviewdetails.F_NAME like '%$sname%' and Paper_type = 'conference' and Paper_N_I = 'national'";
					...
					if($count5 > 0)
					{
						$sql = "SELECT * from paper_review inner join paper_reviewdetails on paper_review.Fac_ID = paper_reviewdetails.Fac_ID and paper_reviewdetails.F_NAME like '%$sname%' and Paper_type = 'conference' and Paper_N_I = 'international'";
					...
					if($count6 > 0)
					{
						$sql = "SELECT * from paper_review inner join paper_reviewdetails on paper_review.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and Paper_type = 'journal' and Paper_N_I = 'national'";
					...
					if($count7 > 0)
					{
						$sql = "SELECT * from paper_review inner join facultydetails on paper_review.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and Paper_type = 'journal' and Paper_N_I = 'international'";
					...
					if($count8 > 0)
					{
						$sql = "SELECT * from paper_review inner join facultydetails on paper_review.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and paper_category = 'peer reviewed'";
					...
					if($count9 > 0)
					{
						$sql = "SELECT * from paper_review inner join facultydetails on paper_review.Fac_ID = facultydetails.Fac_ID and facultydetails.F_NAME like '%$sname%' and paper_category = 'non peer reviewed'";
				...
				<tr> 
 							...
 							<td><strong>paper_review Name</strong></td>
