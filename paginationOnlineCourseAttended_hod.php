...
$_SESSION['type']=$row['type'];
 ...
 $query = "SELECT * from online_course_attended inner join facultydetails on online_course_attended.Fac_ID = facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ORDER BY OC_A_ID DESC LIMIT $start_from,$record_per_page ";  
 ...
 $output .= " 
            <tr> 
                ...
                <th>Duration</th>
                <th class='relative-side'>Credit/Audit</th>
                <th>Updated on</th>
 ...
 {  
      $output .= " 
           <tr> 
                ...
                <td>".$row['duration']."</td>
                <td  class='relative-side'>".$row['credit_audit']."</td>
...
<?php
 ...
 $page_query = "SELECT * from online_course_attended inner join facultydetails on online_course_attended.Fac_ID = facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ORDER BY OC_A_ID DESC";  
 ...
 <br>
   <?php if ($_SESSION['rows'] > 0) {
      ...
      <div>
      <a href="1_add_course_attended_hod.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add Course Attended</span></a> 
      <?php }?>       
                <a href="count_all_online.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Count Courses Attended</span></a> 

                <a href="export_to_excel_online_attended_all.php" type="button" name="export" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a> 
