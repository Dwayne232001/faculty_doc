...
$query = "SELECT * FROM online_course_organised WHERE OC_O_ID=$cardId";
	...
	if(isset($_POST['applicable']))
	{
		...
		else if($_POST['applicable'] == 1)
		{
			...
			date_default_timezone_set('Asia/Kolkata');
			  $targetName=$datapath."attendance/".$_SESSION['F_NAME']."_organised"."_attendance_".date("d-m-Y H-i-s", time()).".".$fileExt;  
