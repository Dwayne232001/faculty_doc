...
if(isset($_POST['insert-image'])){
	...
	if(isset($_POST['applicable']))
	{
		...
		{
			$query = "Update any_other_activity set report_path ='NULL'  where any_other_ID = $cardId";
		...
		{
			$query = "Update any_other_activity set report_path ='not_applicable'  where any_other_ID = $cardId";
             mysqli_query($conn,$query);
			 			 $success =1;
			...
			if(isset($_FILES['image']))
			{
			  ...
			  if(empty($errors)==true) {
				if (file_exists($targetName)) {   
				 ...
				 if($moved == true){
					 //successful
					 $query = "Update any_other_activity set report_path =' ".$targetName."'  where any_other_ID = $cardId";
					 mysqli_query($conn,$query);
					 			 $success =1;
