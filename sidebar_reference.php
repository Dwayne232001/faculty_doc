      ...
      <ul class="sidebar-menu">
		...
		?>
            ...
            <li class="treeview">
			 ...
			 <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Research Details</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class=""><a href="researchFormCount.php"><i class="fa fa-circle-o"></i> Add Research Details</a></li>
                <li><a href="researchView.php"><i class="fa fa-circle-o"></i> View/Edit Research</a></li>
                <li><a href="researchAnalysis.php"><i class="fa fa-circle-o"></i> Analysis</a></li>
                <li><a href="researchChart.php"><i class="fa fa-circle-o"></i> Chart</a></li>
              </ul>
            </li>
           ...
           <li class="treeview">
            ...
            <li class="treeview">
              <a href="#">
                ...
                <span>STTP/Workshop/FDP <br>Attended/Organised</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
			...
			<li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> 
				<span> Organized Guest Lecture</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
				<li class="1"><a href="orglec.php"><i class="fa fa-circle-o"></i>Guest Lecture Organised</a></li>
				<li class="2"><a href="view_organised_lec.php"><i class="fa fa-circle-o"></i>View/Edit Orgainsed</a></li>
			 ...
			 <li <?php if($_SESSION['currentTab']=="online"){echo'class="active treeview"';}else{echo'class="treeview"';}?>>
              ...
              <ul class="treeview-menu">
                <li class=""><a href="actcount_course_attended.php"><i class="fa fa-circle-o"></i>Add Attended Course</a></li>
				  ...
				  <li><a href="2_dashboard_online_attended.php"><i class="fa fa-circle-o"></i>View/Edit Activity Attended</a></li>
				  <li><a href="2_dashboard_online_organised.php"><i class="fa fa-circle-o"></i>View/Edit Activity Orgainsed</a></li>
				  <li><a href="5_fdc_dashboard_online.php"><i class="fa fa-circle-o"></i>FDC details</a></li>
				  <li><a href="count_your_online.php"><i class="fa fa-circle-o"></i>Analysis</a></li>
              </ul>
            </li>
			<li class="treeview">
              ...
              <a href="#">
                <i class="fa fa-table"></i> 
					<span>Any Other Activity</span>
						  ...
						  <ul class="treeview-menu">
							<li><a href="actcount_anyother.php"><i class="fa fa-circle-o"></i>Add Activity</a></li>
