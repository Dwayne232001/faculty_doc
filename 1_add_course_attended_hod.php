					...
					?>
						<form role="form" method="POST" class="row" action="" style="margin:10px;" enctype="multipart/form-data">
							...
							<div class="form-group col-md-6">
								...
								<br><input type='text' class='form-control input-lg' name='department[]' id='department' readOnly value='<?php echo $deptName; ?>'>
							</div>
							<div class="form-group col-md-6">
                          ...
                          <select required class="form-control input-lg" id="type" name="type[]">
							...
							<div class="form-group col-md-6">
								<label for="creau">Mode of Course(audit/certificate)</label><span class="colour"><b> *</b></span>
