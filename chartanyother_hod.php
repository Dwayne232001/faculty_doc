...
if(isset($_POST['submit'])){
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    $query="SELECT * from any_other_activity INNER JOIN facultydetails ON any_other_activity.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
  }
...
{
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    $query2 = "SELECT MIN(Date_from) from any_other_activity WHERE Fac_ID=$fid";

  }
  else{
    $query2 = "SELECT MIN(Date_from) from any_other_activity INNER JOIN facultydetails ON any_other_activity.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
...
while($startYear != $endYear) {
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    $query = "SELECT COUNT(*) FROM any_other_activity WHERE Fac_ID=$fid AND Date_from >= '$date1' AND Date_from <= '$date2'";
  }
  else{
    $query = "SELECT COUNT(*) FROM any_other_activity INNER JOIN facultydetails ON any_other_activity.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' AND Date_from >= '$date1' AND Date_from <= '$date2'";
  }
...
<div class="content-wrapper">
        ...
        <div class="col-xs-12">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" style="width:100px; height:40px" id="print" onclick="window.print();">Print Chart</button>
             <a class="btn btn-primary pull-right" style="height:40px" href="chart_anycurricular_hod.php" >Select Another Faculty</a>
					</div>
				</div>
			</div>
		</div>
          ...
          <div class="row">
			...
			<div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><b>Any Other Activities</b></h3>
