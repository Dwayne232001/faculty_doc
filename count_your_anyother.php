          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary">
				...
				<!--	<a href="menu.php?menu=8 "> <u>Back to Any Other Activities Menu</u></a> -->
				</div>
                <!-- form start -->
                <form role="form" action = "count_your_anyother.php" method="post">
                  <div class="box-body">
				...
				<a href="2_dashboard_anyother.php" type="button" class="btn btn-primary" >Back to View Mode </a>
				 </form>
                     ...
                     <?php
				       if(isset($_POST['count_total']))
					   {
						  ...
						  #k1,#k2,#k3
						   ...
						   $q1="select * from any_other_activity where Date_from>='$from_date' AND Date_from<='$to_date' and Fac_ID='$Fac_ID'";
						   $_SESSION['sql']=$q1;
				   ...
				   if(isset($_SESSION['count']))
				   {
					   ...
					   ?>
						<button class="btn btn-primary" id="print" onclick="window.print();">Print</button>
				 		<a href="export_to_excel_analysis_anyother.php" type="button" class="btn btn-primary" id="k2" class="hide1" target="_blank">Export to Excel</a>
