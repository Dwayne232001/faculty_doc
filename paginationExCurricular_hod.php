...
$_SESSION['type']=$row['type'];
 ...
 $query = "SELECT * from ex_curricular inner join facultydetails on ex_curricular.Fac_ID = facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ORDER BY ex_curricular_ID DESC LIMIT $start_from,$record_per_page ";  
...
<?php
 ...
 $page_query = "SELECT * from ex_curricular inner join facultydetails on ex_curricular.Fac_ID = facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' ORDER BY ex_curricular_ID DESC";  
...
if($_SESSION['type'] == 'hod'){?>
 <div>
<a href="1_add_activity_multiple_hod_excurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add ExCurricular Activity</span></a> 
<?php }?>
              <a href="count_all_excurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon ">Count ExCurricular Activitiess</span></a> 

              <a href="export_to_excel_hod_excurricular.php" type="button" name="export" class="btn btn-success btn-sm"><span class="glyphicon ">Export to Excel</span></a> 

  <?php }else {
              
if($_SESSION['type'] == 'hod'){?>
              <div class="text-left"><a href="1_add_activity_multiple_hod_excurricular.php" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus">Add ExCurricular Activity</span></a>
