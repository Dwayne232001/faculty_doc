...
$query = "SELECT * FROM any_other_activity WHERE any_other_ID=$cardId";
...
if(isset($_POST['insert-image'])){
	...
	if(isset($_POST['applicable']))
	{
		...
		{
			$query = "Update any_other_activity set permission_path ='NULL'  where any_other_ID = $cardId";
		...
		{
			$query = "Update any_other_activity set permission_path ='not_applicable'  where any_other_ID = $cardId";
             mysqli_query($conn,$query);
			 			 $success =1;
			...
			if(isset($_FILES['image']))
			{
			  ...
			  if(empty($errors)==true) {
				if (file_exists($targetName)) {   
				 ...
				 if($moved == true){
					 //successful
					 $query = "Update any_other_activity set permission_path =' ".$targetName."'  where any_other_ID = $cardId";
					 mysqli_query($conn,$query);
					 			 $success =1;
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
					...
					<h3 class="box-title"><b>Upload Permission Letter</b></h3>
					</div>
