...
$sql1="SELECT * from $type where Act_type='$activity' and Fac_ID=$fid";
...
if ($count>0) {
  # code...
  $query2 = "SELECT MIN(Date_from) from $type where Act_type='$activity' and Fac_ID=$fid";
  ...
  while($startYear != $endYear) {
    ...
    $query = "SELECT COUNT(*) FROM $type WHERE Act_type='$activity' && Date_from >= '$date1' AND Date_to <= '$date2' AND Fac_ID=$fid";
