				...
				<div class="form-group col-md-6">
					...
					<input required type="text" class="form-control input-lg" id="faculty-name" name="facultyName" value="<?php echo $faculty_name; ?>" readonly>
                     ...
                     <div class="form-group col-md-6">
					  ...
					  <input required <?php if(isset($_POST['paperTitle'])) echo "value = $paperTitle"; ?> type="text" class="form-control input-lg"  name="paperTitle[]" >
                     </div>
                     ...
                     <div class="form-group col-md-6">
     				  ...
     				  <div class="form-group col-md-6">
                         ...
                         <input type="text" class="form-control input-lg" id="conf" name="conf[]" value = '<?php if(isset($_POST['conf'])) echo $conf; ?>'>
                     </div>
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                         ...
                         <input type="text"  required class="form-control input-lg" id="details" name="details[]" value = '<?php if(isset($_POST['details'])) echo $details; ?>'>
                     </div>
