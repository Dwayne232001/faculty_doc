...
?>								
                    ...
                    <div class="form-group col-md-6">
                     ...
                     <div class="form-group col-md-6">
                         ...
                         <input type="text"  required class="form-control input-lg" id="purpose" name="purpose[]" >
                     </div>
                     
					            <div class="form-group col-md-6">
                         <label for="target">Target Audience * </label>
                         <input type="text"  required class="form-control input-lg" id="target" name="target[]" >
                     </div>

                     <div class="form-group col-md-6">
                         <label for="role">Faculty Role *</label>
                         <input type="text"  required class="form-control input-lg" id="role" name="role[]" >
                     </div>
                      <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                          ...
                          <input <?php if(isset($_POST['participants'])) echo "value = $no_of_part"; ?>  required type="number" class="form-control input-lg"  id="participants" name="participants[]">
                      </div>
                      <div class="form-group col-md-6">
...
<div class="form-group col-md-6 col-md-offset-1"></div>
                      ...
                      <div class="form-group col-md-6">
                          ...
                          <input required type='radio' name='sponsored' class='sponsored' value='sponsored' > Sponsored
                      </div>
             ...
             <div >
                   ...
                   <?php
                    ...
                    <div class="form-group col-md-12">
                         ...
                         <a href="menu.php?menu=5" type="button" class="btn btn-warning btn-lg">Cancel</a>
                    </div>
                </form>
                </div>
              </div>
