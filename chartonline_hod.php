...
if(isset($_POST['submit'])){
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    if($_SESSION['type_online'] == 'Attended')	
      $query="SELECT * from online_course_attended INNER JOIN facultydetails ON online_course_attended.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
    else if($_SESSION['type_online'] == 'Organised')
      $query="SELECT * from online_course_organised INNER JOIN facultydetails ON online_course_organised.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
  }
...
if(mysqli_num_rows($sql)>0)
{
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    if($_SESSION['type_online'] == 'Attended')
      $query2 = "SELECT MIN(Date_From) from online_course_attended INNER JOIN facultydetails ON online_course_attended.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
    else if($_SESSION['type_online'] == 'Organised')
      $query2 = "SELECT MIN(Date_From) from online_course_organised INNER JOIN facultydetails ON online_course_organised.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
  }
...
while($startYear != $endYear) {
  ...
  if(isset($_POST['name']) && $_POST['name']!="" && $_POST['name']!="All Faculty"){
    ...
    if($_SESSION['type_online'] == 'Attended'){
      $query = "SELECT COUNT(*) FROM online_course_attended INNER JOIN facultydetails ON online_course_attended.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' AND Date_To >= '$date1' AND Date_From <= '$date2'";
      $query1="SELECT type_of_course from online_course_attended INNER JOIN facultydetails ON online_course_attended.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
    }
    else if($_SESSION['type_online'] == 'Organised'){
      $query = "SELECT COUNT(*) FROM online_course_organised INNER JOIN facultydetails ON online_course_organised.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."' AND Date_To >= '$date1' AND Date_From <= '$date2'";
      $query1="SELECT type_of_course from online_course_organised INNER JOIN facultydetails ON online_course_organised.Fac_ID=facultydetails.Fac_ID WHERE facultydetails.Dept='".$_SESSION['Dept']."'";
    }
  }
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary" style="width:100px; height:40px" id="print" onclick="window.print();">Print Chart</button>
             <a class="btn btn-primary pull-right" style="height:40px" href="chart_online_hod.php" >Select Another Faculty</a>
			</div>
		</div>
		</div>
          <div class="row">
