	...
	<?php
			...
			?>			
					...
					<div class="form-group col-md-12">
                        ...
                        <input required type="text" class="form-control input-lg" id="department" name="department[]" value="<?php echo $deptName; ?>" readonly>
                    </div>
					...
					<div class="form-group col-md-6">					 
					 <label for="c_name">Name of Investigator</label><span class="colour"><b> *</b></span>
                     ...
                     <div class="form-group col-md-6">
					 <label for="co_auth">Name of Investigator(If Not From Faculty)</label><span class="colour"><b> *</b></span>
	                     	<div class="table-repsonsive">
						     <span id="error"></span>
					...
					<div class="form-group col-md-6" id="application_number">
                         ...
                         <input  <?php if (isset($_POST['sanctionedAmount'])) echo "value = $sanctionedAmount"; ?> type="text" class="form-control input-lg" id="application_number" name="application_number[]" required>
                     </div>

					<div class="form-group col-md-6">
                         <label for="filing-grant-date">Date of Filing/Grant </label><span class="colour"><b> *</b></span>
                         <input <?php if(isset($_POST['startDate'])) echo "value = $startDate"; ?> required type="date" class="form-control input-lg" id="filing-grant-date" name="filing-grant-date[]"
                         placeholder="03:10:10">
                     </div>

					 <div class="form-group col-md-6">
                         <label for="publication-date">Date of Publication </label><span class="colour"><b> *</b></span>
                         <input <?php if(isset($_POST['startDate'])) echo "value = $startDate"; ?> required type="date" class="form-control input-lg" id="publication-date" name="publication-date[]"
                         placeholder="03:10:10">
                     </div>
